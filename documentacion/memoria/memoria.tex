...
\vspace{1cm}
\large
\textbf{Autor :} Cristian Fabián Martínez Rosero \\
\textbf{Tutor :} Dr. Óscar Barquero Pérez
...
Para la capa de persistencia, se ha utilizado una base de datos no relacional, MongoDB.
Tanto el lado del cliente, como para el lado del servidor y la comunicación entre servidor y la base de datos, se ha utilizado sintáxis de Python para codificar sus funcionalidades.

En la figura~\ref{fig:arquitectura}  se muestra un esquema a grandes rasgos de los componentes que intervienen en la arquitectura de la aplicación.
\begin{figure}
  \centering
  \includegraphics[width=16cm, keepaspectratio]{img/arquitectura}
  \caption{Arquitectura de la aplicación.}
  \label{fig:arquitectura}
\end{figure}

%¿Cómo funciona la interacción básica entre el lado cliente  con el lado servidor?

Cuando un usuario realiza la petición de la página principal de la aplicación mediante el navegador, éste realizará una petición HTTP al servidor pidiendo dicho recurso. El servidor comprobará si el recurso existe, utilizará las herramientas de Dash para renderizar el código Python en componentes HTML + React, y enviará el resultado en una respuesta HTTP al navegador, el cual interpretará la página devuelta y mostrará los distintos componentes de esta en pantalla.
...
\label{sec:implementacion-servidor}

% Resumen de lo que hace el servidor
